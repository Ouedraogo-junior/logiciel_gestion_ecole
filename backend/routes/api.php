...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::middleware('role:direction')->group(function () {
            ...
            Route::get('/examens-nationaux', [ExamenNationalController::class, 'index']);
            Route::post('/examens-nationaux', [ExamenNationalController::class, 'store']);
            Route::patch('/examens-nationaux/{examenNational}', [ExamenNationalController::class, 'update']);
            Route::post('/examens-nationaux/inscription-masse', [ExamenNationalController::class, 'inscriptionMasse']);

            Route::post('/emplois-du-temps', [EmploiDuTempsController::class, 'store']);
            Route::patch('/emplois-du-temps/{emploiDuTemps}', [EmploiDuTempsController::class, 'update']);
            Route::delete('/emplois-du-temps/{emploiDuTemps}', [EmploiDuTempsController::class, 'destroy']);
            Route::get('/classes/{classe}/emploi-du-temps/pdf', [EmploiDuTempsController::class, 'genererPdf']);
        });
    });
});